...
w1 = Wig.create(title: "Red", user: User.first, description: "red hair", price: "15", photo: "http://res.cloudinary.com/dtqkxojhd/image/upload/v1543312837/20170927163904_28607.jpg")
